...
import { Avatar, Card, Fab, IconButton, Typography } from "@material-ui/core";
...
<div style={{position: 'absolute', left: 0, top: 0, right: 0, bottom: 0, backgroundColor: '#fff', direction: 'ltr'}}>
  <div style={{position: 'relative'}}>
    ...
    <Card style={{borderRadius: 56, backgroundColor: '#666', padding: 4, width: 112, height: 112, position: 'absolute', marginTop: -144, right: 32}}>
    ...
    <div style={{position: 'absolute', width: '100%', right: 32, marginTop: -356}}>
      <div style={{width: '100%'}}>
        <IconButton style={{width: 32, height: 32, position: 'absolute', right: -16}} onClick={() => gotoPage('/app/messenger')}>
    ...
    <div style={{position: 'absolute', width: 'auto', height: 40, right: 32, marginTop: 32, marginTop: -276, display: 'flex', flexWrap: 'wrap', direction: 'rtl'}}>
  ...
  <Fab color={'secondary'} style={{position: 'absolute', left: 32, marginTop: -176}}>
    <EditIcon/>
  </Fab>
  <div style={{position: 'absolute', width: '100%', right: 200, marginTop: -116, display: 'flex', direction: 'rtl'}}>
      <div style={{color: '#fff', marginLeft: 12, justifyContent: 'center', textAlign: 'center', marginTop: 12, fontSize: 18,
                    background: 'rgba(255, 255, 255, 0.35)', borderRadius: 20, padding: 8}}>
        <div style={{color: '#666',
      ...
      <div style={{marginRight: 12, color: '#fff', marginLeft: 12, justifyContent: 'center', textAlign: 'center', marginTop: 12, fontSize: 18,
                    background: 'rgba(255, 255, 255, 0.35)', borderRadius: 20, padding: 8}}>
        <div style={{color: '#666',
          justifyContent: 'center', textAlign: 'center', fontWeight: 'bold', fontSize: 18, marginTop: -4}}>
          25
  ...
  <div style={{width: '100%', height: 'auto', zIndex: 2, position: 'relative', padding: 16}}>
