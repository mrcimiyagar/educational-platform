    ...
    return (
      ...
      <div className={classes.root}>
        ...
        <AppBar style={{alignItems: 'center', justifyContent: 'center', textAlign: 'center',
                        ...
                        zIndex: 99999, borderRadius: '0px 0px 24px 24px', transition: 'top 1s'}}>
      ...
      <BottomNavigation
          ...
          style={{zIndex: 99999, width: 300, height: 80, borderRadius: 40, position: 'fixed', left: inTheGame ? 32 : -200, transition: 'left 1s', top: '50%', transform: 'translateY(-50%) rotateZ(90deg)', backgroundColor: colors.primaryMedium}}
        >
