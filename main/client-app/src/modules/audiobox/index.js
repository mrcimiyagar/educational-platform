...
export let AudioBox = (props) => {
    ...
    return (
      <div style={{backgroundColor: isDesktop() ? 'rgba(255, 255, 255, 0.5)' : undefined, backdropFilter: 'blur(10px)', borderRadius: isDesktop() ? 24 : undefined, height: isDesktop() ? 650 : '100%', width: isDesktop() ? 500 : 'calc(100% + 32px)', 
