    ...
    return (
      ...
      >
        ...
        <iframe scrolling="no"
          ...
          style={{
            width: (props.currentRoomNav !== 2 && !props.webcamOnSecond) ? 450 : '100%', height: (props.currentRoomNav !== 2 && !props.webcamOn) ? 300 : '100%', marginTop: (isDesktop() && isInRoom()) ? 0 : 64, marginBottom: 32}} frameBorder="0"></iframe>
      </div>
    );
}
